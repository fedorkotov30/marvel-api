...
},{"axios":"../node_modules/axios/index.js","../constants/api.js":"../src/constants/api.js"}],"../src/constants/root.js":[function(require,module,exports) {
"use strict";
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/components/App/App.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/components/Notification/Notification.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../src/components/Notification/img/close-black.svg":[function(require,module,exports) {
module.exports = "/close-black.0f0d6dc0.svg";
},{}],"../src/components/Notification/Notification.js":[function(require,module,exports) {
"use strict";
...
require("../App/App.css");
var _closeBlack = _interopRequireDefault(require("../Notification/img/close-black.svg"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
...
var Notification = /*#__PURE__*/function () {
  ...
  _createClass(Notification, [{
    ...
    value: function render() {
      var htmlWrapper = "\n        <div class=\"notification__container\">\n            <span>\u041D\u0435\u0442 \u043A\u043E\u043D\u0442\u0435\u043D\u0442\u0430</span>\n            <button class=\"btn notification__close\" onclick=\"modal.innerHTML = ''\" style=\"background-image: url(".concat(_closeBlack.default, ")\"></button>\n        </div>\n    ");
...
exports.default = _default;
},{"../../constants/root":"../src/constants/root.js","./Notification.css":"../src/components/Notification/Notification.css","../App/App.css":"../src/components/App/App.css","../Notification/img/close-black.svg":"../src/components/Notification/img/close-black.svg"}],"../src/components/Characters/img/close-white.svg":[function(require,module,exports) {
...
var _closeWhite = _interopRequireDefault(require("../Characters/img/close-white.svg"));
var _api = require("../../constants/api.js");
var _root = require("../../constants/root");
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
console.log(_closeWhite.default);
  ...
  _createClass(Characters, [{
    ...
    value: function renderContent(data) {
      ...
      data.forEach(function (_ref) {
        ...
        htmlContent += "\n        <li class=\"characters__item\">\n            <img class=\"img-cover characters__img\" src=\"".concat(imgSrc, "\"/>\n            <span class=\"characters__name\">").concat(name, "</span>\n        </li>\n      ");
      });
      var htmlWrapper = "s\n    <div class=\"wrapper\">\n        <ul class=\"characters__container\">\n            ".concat(htmlContent, "\n        </ul>\n        <button class=\"btn characters__close\" onclick=\"modal.innerHTML = ''\" style=\"background-image: url(").concat(_closeWhite.default, ")\"></button>\n    </div>    \n    ");
      _root.ROOT_MODAL.innerHTML = htmlWrapper;
    }
  }, {
    key: "render",
...
exports.default = _default;
},{"./Characters.css":"../src/components/Characters/Characters.css","../App/App.css":"../src/components/App/App.css","../Notification/Notification":"../src/components/Notification/Notification.js","../Characters/img/close-white.svg":"../src/components/Characters/img/close-white.svg","../../constants/api.js":"../src/constants/api.js","../../constants/root":"../src/constants/root.js","../../utils/getDataApi.js":"../src/utils/getDataApi.js"}],"../src/components/Error/Error.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
...
exports.default = _default;
},{"./Error.css":"../src/components/Error/Error.css","../../constants/root":"../src/constants/root.js"}],"../src/components/Comics/Comics.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
...
var _api = require("../../constants/api.js");
var _getDataApi = require("../../utils/getDataApi.js");
var _root = require("../../constants/root.js");
var _Characters = _interopRequireDefault(require("../Characters/Characters.js"));
var _Error2 = _interopRequireDefault(require("../Error/Error.js"));
require("./Comics.css");
require("../App/App.css");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
exports.default = _default;
},{"../../constants/api.js":"../src/constants/api.js","../../utils/getDataApi.js":"../src/utils/getDataApi.js","../../constants/root.js":"../src/constants/root.js","../Characters/Characters.js":"../src/components/Characters/Characters.js","../Error/Error.js":"../src/components/Error/Error.js","./Comics.css":"../src/components/Comics/Comics.css","../App/App.css":"../src/components/App/App.css"}],"../src/components/App/App.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../Comics/Comics":"../src/components/Comics/Comics.js","./App.css":"../src/components/App/App.css"}],"../src/components/App/index.js":[function(require,module,exports) {
"use strict";
...
},{"regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","./components/App":"../src/components/App/index.js","./components/Comics/Comics":"../src/components/Comics/Comics.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
